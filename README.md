...
```scala
libraryDependencies += "com.github.gchudnov" %% "bscript-b1" % "1.3.6"

// Optionally, include one or more of the more specific dependencies
libraryDependencies += "com.github.gchudnov" %% "bscript-lang" % "1.3.6"
libraryDependencies += "com.github.gchudnov" %% "bscript-builder" % "1.3.6"
libraryDependencies += "com.github.gchudnov" %% "bscript-interpreter" % "1.3.6"
libraryDependencies += "com.github.gchudnov" %% "bscript-inspector" % "1.3.6"
