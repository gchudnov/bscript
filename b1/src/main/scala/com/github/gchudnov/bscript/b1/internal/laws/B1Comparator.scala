...
final class B1Comparator() extends Comparator:
  ...
  override def less(lhs: Cell, rhs: Cell): Either[Throwable, Cell] = (lhs, rhs) match
    ...
    case (DateCell(x), DateCell(y))         => Right(BoolCell(x.isBefore(y)))
    case (DateTimeCell(x), DateTimeCell(y)) => Right(BoolCell(x.isBefore(y)))
  ...
  override def lessEqual(lhs: Cell, rhs: Cell): Either[Throwable, Cell] = (lhs, rhs) match
    ...
    case (DecimalCell(x), DecimalCell(y))   => Right(BoolCell(x <= y))
    case (StrCell(x), StrCell(y))           => Right(BoolCell(x <= y))
    case (DateCell(x), DateCell(y))         => Right(BoolCell(x.isBefore(y) || x.isEqual(y)))
    case (DateTimeCell(x), DateTimeCell(y)) => Right(BoolCell(x.isBefore(y) || x.isEqual(y)))
  ...
  override def greater(lhs: Cell, rhs: Cell): Either[Throwable, Cell] = (lhs, rhs) match
    ...
    case (DecimalCell(x), DecimalCell(y))   => Right(BoolCell(x > y))
    case (StrCell(x), StrCell(y))           => Right(BoolCell(x > y))
    case (DateCell(x), DateCell(y))         => Right(BoolCell(x.isAfter(y)))
    case (DateTimeCell(x), DateTimeCell(y)) => Right(BoolCell(x.isAfter(y)))
  ...
  override def greaterEqual(lhs: Cell, rhs: Cell): Either[Throwable, Cell] = (lhs, rhs) match
    ...
    case (DecimalCell(x), DecimalCell(y))   => Right(BoolCell(x >= y))
    case (StrCell(x), StrCell(y))           => Right(BoolCell(x >= y))
    case (DateCell(x), DateCell(y))         => Right(BoolCell(x.isAfter(y) || x.isEqual(y)))
    case (DateTimeCell(x), DateTimeCell(y)) => Right(BoolCell(x.isAfter(y) || x.isEqual(y)))
  ...
  override def equal(lhs: Cell, rhs: Cell): Either[Throwable, Cell] = (lhs, rhs) match
    ...
    case (DecimalCell(x), DecimalCell(y))   => Right(BoolCell(x == y))
    case (StrCell(x), StrCell(y))           => Right(BoolCell(x == y))
    case (DateCell(x), DateCell(y))         => Right(BoolCell(x.isEqual(y)))
    case (DateTimeCell(x), DateTimeCell(y)) => Right(BoolCell(x.isEqual(y)))
