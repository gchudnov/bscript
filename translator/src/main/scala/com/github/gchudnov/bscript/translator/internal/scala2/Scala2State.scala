...
final case class Scala2State(meta: Meta, lines: Seq[String], imports: Set[String]):
  def show(): String =
...
object Scala2State:
  def make(meta: Meta): Scala2State =
    new Scala2State(meta = meta, lines = Vector.empty[String], imports = Set.empty[String])
