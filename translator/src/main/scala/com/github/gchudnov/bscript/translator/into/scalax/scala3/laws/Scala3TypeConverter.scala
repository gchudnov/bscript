package com.github.gchudnov.bscript.translator.into.scala3.laws
 ...
 */
private[into] final class Scala3TypeConverter(typeNames: TypeNames) extends TypeNames with TypeConverter:
