package com.github.gchudnov.bscript.translator.into.scalax.scala3j.laws
 ...
 */
private[into] class Scala3JTypeConverter(typeNames: TypeNames) extends TypeNames with TypeConverter:
